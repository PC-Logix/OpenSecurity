...
public class CamouflageBakedModel implements IPerspectiveAwareModel {
  ...
  public static final ModelResourceLocation blockStatesFileName
          = new ModelResourceLocation(OpenSecurity.MODID + ":door_controller");

  // create a variant tag (ModelResourceLocation) for our block
  public static final ModelResourceLocation variantTag
          = new ModelResourceLocation(OpenSecurity.MODID + ":door_controller", "normal");
  ...
  private IBakedModel handleBlockState(@Nullable IBlockState iBlockState)
  {
    ...
    if (iBlockState instanceof IExtendedBlockState) {
      ...
      IBlockState copiedBlockIBlockState = iExtendedBlockState.getValue(BlockDoorController.COPIEDBLOCK);
